...
const fetchArticles = async () => {
  ...
  try {
    ...
    errorMessage.value = error.response?.data?.message || 'An error occurred while fetching articles'
  } finally {
...
const deleteArticle = async () => {
  ...
  try {
    ...
    errorMessage.value = error.response?.data?.message || 'An error occurred while deleting the article'
    showDeleteModal.value = false
  } finally {
...
const navigateToEdit = (articleId) => {
